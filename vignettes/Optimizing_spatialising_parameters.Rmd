...
```{r}
maine2016_metrics = c(m_index(maine2016), texture_index(maine2016))
sim1_metrics = c(m_index(sim1), texture_index(sim1))
sim2_metrics = c(m_index(sim2), texture_index(sim2))
```
...
optimize_model = function(x){
  ...
  maine2016_metrics = c(m_index(maine2016), texture_index(maine2016))
  sim_metrics = c(m_index(sim), texture_index(sim))             
...
```{r}
sim_optim_metrics = c(m_index(sim_optim), texture_index(sim_optim))             
